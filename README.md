...
If you find some issue please check the latest tested version in the `package.json` file of the E2E tests at https://github.com/javierbrea/cypress-fail-fast/blob/main/tests-e2e/cypress-5/package.json
